...
class OCTCTuningOverview(Plotting):
    ...
    def subplot(self, subplotspec):
        ...
        dsv = param_filter_query(
            self.datastore, st_name='DriftingSinusoidalGratingCenterSurroundStimulus', value_name=['Firing rate'])
        plots['L4ExcFR'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l4_neurons, 'sheet_name': 'V1_Exc_L4', 'centered': False, 'mean': True, 'polar': False, 'pool': False})), gs[0:4, 0:4], {
                            'fontsize': fontsize, 'title': None, 'x_label': None, 'y_label': r'Firing rate ($\frac{sp}{s}$)', 'x_axis': False, 'x_ticks': False})
        if self.parameters.l23_neurons != []:
            plots['L23ExcFR'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l23_neurons, 'sheet_name': 'V1_Exc_L2/3', 'centered': False,
                                                                    'mean': True, 'polar': False, 'pool': False})), gs[4:8, 0:4], {'fontsize': fontsize, 'title': None, 'y_label': r'Firing rate ($\frac{sp}{s}$)', 'x_label': 'Surround orientation'})

        dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingCenterSurroundStimulus', value_name=[
                                 '-(x+y)(F0_Vm,Mean(VM))'])
        plots['L4ExcVm'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l4_neurons_analog, 'sheet_name': 'V1_Exc_L4', 'centered': False,
                                                               'mean': True, 'polar': False, 'pool': False})), gs[0:4, 5:9], {'y_lim': (-3, 1), 'fontsize': fontsize, 'title': None, 'x_label': None, 'y_label': r'Vm (mV)', 'x_axis': False, 'x_ticks': False})
        if self.parameters.l23_neurons != []:
            dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingCenterSurroundStimulus', value_name=[
                                     '-(x+y)(F0_Vm,Mean(VM))'])
            plots['L23ExcVm'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l23_neurons_analog, 'sheet_name': 'V1_Exc_L2/3', 'centered': False,
                                                                    'mean': True, 'polar': False, 'pool': False})), gs[4:8, 5:9], {'y_lim': (-3, 1), 'fontsize': fontsize, 'title': None, 'y_label': r'Vm (mV)', 'x_label': 'Surround orientation'})

        dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingCenterSurroundStimulus',
                                 value_name='PerNeuronMean(Vm (no AP) trial-to-trial variance)')
        plots['L4ExcTTV'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l4_neurons_analog, 'sheet_name': 'V1_Exc_L4', 'centered': False,
                                                                'mean': True, 'polar': False, 'pool': True})), gs[0:4, 10:14], {'fontsize': fontsize, 'title': None, 'x_label': None, 'x_axis': False, 'x_ticks': False, 'y_label': 'Var of Vm (nS)'})
        if self.parameters.l23_neurons != []:
            dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingCenterSurroundStimulus',
                                     value_name='PerNeuronMean(Vm (no AP) trial-to-trial variance)')
            plots['L23ExcTTV'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l23_neurons_analog, 'sheet_name': 'V1_Exc_L2/3',
                                                                     'centered': False, 'mean': True, 'polar': False, 'pool': True})), gs[4:8, 10:14], {'fontsize': fontsize, 'title': None, 'y_label': 'Var of Vm (nS)', 'x_label': 'Surround orientation'})

        dsv = param_filter_query(self.datastore, value_name=[
                                 'Suppression index of Firing rate'], sheet_name='V1_Exc_L4')
        plots['L4ExcSI'] = (PerNeuronValuePlot(dsv, ParameterSet({'cortical_view': False})), gs[0:4, 15:19], {
                            'fontsize': fontsize, 'title': None, 'x_label': None, 'y_label': '# neurons', 'x_axis': False, 'x_ticks': False, 'num_bins': 20, 'mark_mean': False, 'x_lim': (0, 3.0), 'y_lim': (0, 12)})
        if self.parameters.l23_neurons != []:
            dsv = param_filter_query(self.datastore, value_name=[
                                     'Suppression index of Firing rate'], sheet_name='V1_Exc_L2/3')
            plots['L2/3ExcSI'] = (PerNeuronValuePlot(dsv, ParameterSet({'cortical_view': False})), gs[4:8, 15:19], {'fontsize': fontsize, 'title': None,
                                                                                                                    'x_label': None, 'y_label': '# neurons', 'x_label': 'Suppression index', 'num_bins': 20, 'mark_mean': False, 'x_lim': (0, 3.0), 'y_lim': (0, 12)})

        dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingCenterSurroundStimulus', value_name=[
                                 'F0_Exc_Cond', 'F0_Inh_Cond'])
        plots['L4ExcCond'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l4_neurons_analog, 'sheet_name': 'V1_Exc_L4', 'centered': False, 'mean': True, 'polar': False, 'pool': True})), gs[0:4, 20:24], {
                              'y_lim': (0, 20), 'fontsize': fontsize, 'title': None, 'x_label': None, 'x_axis': False, 'x_ticks': False, 'y_label': 'Conductance (nS)', 'colors': {'F0_Exc_Cond': '#FF0000', 'F0_Inh_Cond': '#0000FF'}})
        if self.parameters.l23_neurons != []:
            dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingCenterSurroundStimulus', value_name=[
                                     'F0_Exc_Cond', 'F0_Inh_Cond'])
            plots['L23ExcCond'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': self.parameters.l23_neurons_analog, 'sheet_name': 'V1_Exc_L2/3', 'centered': False, 'mean': True, 'polar': False, 'pool': True})), gs[4:8, 20:24], {
                                   'y_lim': (0, 20), 'fontsize': fontsize, 'title': None, 'y_label': 'Conductance (nS)', 'x_label': 'Surround orientation', 'colors': {'F0_Exc_Cond': '#FF0000', 'F0_Inh_Cond': '#0000FF'}})
