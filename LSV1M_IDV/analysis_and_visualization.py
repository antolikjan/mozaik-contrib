...
def analysis(data_store,analog_ids,analog_ids_inh,analog_ids23=None,analog_ids_inh23=None):
	...
	param_filter_query(data_store,analysis_algorithm='TrialVariability').print_content(full_ADS=True)
	...
	dsv = param_filter_query(data_store,st_name='FullfieldDriftingSinusoidalGrating',value_name=['F0(psth (bin=10.0) trial-to-trial mean)'],analysis_algorithm='Analog_F0andF1',sheet_name=sheets)    
	GaussianTuningCurveFit(dsv,ParameterSet({'parameter_name' : 'orientation'})).analyse()
	CircularVarianceOfTuningCurve(dsv,ParameterSet({'parameter_name' : 'orientation'})).analyse()
    ...
    if True:
            ...
            if True:
                ...
                if len(param_filter_query(data_store,sheet_name=['V1_Exc_L4'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0]).get_analysis_result()) != 0:    
                    pref_fr_50 = param_filter_query(data_store,sheet_name=['V1_Exc_L4'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0],ads_unique=True).get_analysis_result()[0].get_value_by_id(l4_exc_or_many)
                    ort_fr_50 = param_filter_query(data_store,sheet_name=['V1_Exc_L4'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[numpy.pi/2],ads_unique=True).get_analysis_result()[0].get_value_by_id(l4_exc_or_many)
                ...
                if len(param_filter_query(data_store,sheet_name=['V1_Inh_L4'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0]).get_analysis_result()) != 0:    
                    pref_fr_50 = param_filter_query(data_store,sheet_name=['V1_Inh_L4'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0],ads_unique=True).get_analysis_result()[0].get_value_by_id(l4_inh_or_many)
                    ort_fr_50 = param_filter_query(data_store,sheet_name=['V1_Inh_L4'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[numpy.pi/2],ads_unique=True).get_analysis_result()[0].get_value_by_id(l4_inh_or_many)
                ...
                pylab.savefig(Global.root_directory+"Orientation_responsInheL4.png")
                ...
                if l23:
                    ...
                    if(len(param_filter_query(data_store,sheet_name=['V1_Exc_L2/3'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0]).get_analysis_result())!=0):
                        pref_fr_50 = param_filter_query(data_store,sheet_name=['V1_Exc_L2/3'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0],ads_unique=True).get_analysis_result()[0].get_value_by_id(l23_exc_or_many)
                        ort_fr_50 = param_filter_query(data_store,sheet_name=['V1_Exc_L2/3'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[numpy.pi/2],ads_unique=True).get_analysis_result()[0].get_value_by_id(l23_exc_or_many)
                    ...
                    if(len(param_filter_query(data_store,sheet_name=['V1_Inh_L2/3'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0]).get_analysis_result())!=0):
                        pref_fr_50 = param_filter_query(data_store,sheet_name=['V1_Inh_L2/3'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[0],ads_unique=True).get_analysis_result()[0].get_value_by_id(l23_inh_or_many)
                        ort_fr_50 = param_filter_query(data_store,sheet_name=['V1_Inh_L2/3'],st_contrast=[low_contrast],analysis_algorithm=['TrialAveragedFiringRate'],value_name='Firing rate',st_orientation=[numpy.pi/2],ads_unique=True).get_analysis_result()[0].get_value_by_id(l23_inh_or_many)
                    ...
                    pylab.savefig(Global.root_directory+"Orientation_responseInh23.png")
            ...
            RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neurons' : spike_ids,'trial_averaged_histogram': False, 'spontaneous' : False}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='NatExcRasterL4.png').plot({'SpikeRasterPlot.group_trials':True})
            RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neurons' : spike_ids_inh,'trial_averaged_histogram': False, 'spontaneous' : False}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='NatInhRasterL4.png').plot({'SpikeRasterPlot.group_trials':True})

            if l23:
                RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L2/3', 'neurons' : spike_ids23,'trial_averaged_histogram': False, 'spontaneous' : False}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='NatExcRasterL23.png').plot({'SpikeRasterPlot.group_trials':True})
                RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L2/3', 'neurons' : spike_ids_inh23,'trial_averaged_histogram': False, 'spontaneous' : False}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='NatInhRasterL23.png').plot({'SpikeRasterPlot.group_trials':True})
...
def perform_analysis_and_visualization_stc(data_store):
    ...
    center4 = l4_exc_or_many[numpy.nonzero(numpy.sqrt(numpy.multiply(x,x)+numpy.multiply(y,y)) < 0.4)[0]]
    ...
    if l23:
        ...
        center23 = l23_exc_or_many[numpy.nonzero(numpy.sqrt(numpy.multiply(x,x)+numpy.multiply(y,y)) < 0.4)[0]]
...
#        OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L2/3', 'neuron' : list(analog_center23)[2], 'sheet_activity' : {}, 'spontaneous' : True}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='Overview_ExcL23_3.png').plot()
	...
	SizeTuningOverviewNew(data_store,ParameterSet({'l4_neurons' : list(center4),'l23_neurons' : list(center23),'l4_neurons_analog' : list(analog_center4),'l23_neurons_analog' : list(analog_center23)}),plot_file_name='SizeTuningOverviewNew.png',fig_param={'dpi' : 300,'figsize': (18,8)}).plot()
    else:
        ...
        SizeTuningOverviewNew(data_store,ParameterSet({'l4_neurons' : list(center4),'l23_neurons' : [],'l4_neurons_analog' : list(analog_center4),'l23_neurons_analog' : []}),plot_file_name='SizeTuningOverviewNew.png',fig_param={'dpi' : 300,'figsize': (18,8)}).plot()


    if True:
        dsv = param_filter_query(data_store,st_name=['DriftingSinusoidalGratingDisk'],st_size=[5.0])    
        OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : list(analog_center4)[0], 'sheet_activity' : {}, 'spontaneous' : True}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='Overview_ExcL4_Small1.png').plot()
        OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : list(analog_center4)[1], 'sheet_activity' : {}, 'spontaneous' : True}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='Overview_ExcL4_Small2.png').plot()
        OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : list(analog_center4)[2], 'sheet_activity' : {}, 'spontaneous' : True}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='Overview_ExcL4_Small3.png').plot()
    
        OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L2/3', 'neuron' : list(analog_center23)[0], 'sheet_activity' : {}, 'spontaneous' : True}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='Overview_ExcL23_Small1.png').plot()
        OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L2/3', 'neuron' : list(analog_center23)[1], 'sheet_activity' : {}, 'spontaneous' : True}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='Overview_ExcL23_Small2.png').plot()
        OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L2/3', 'neuron' : list(analog_center23)[2], 'sheet_activity' : {}, 'spontaneous' : True}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='Overview_ExcL23_Small3.png').plot()

	RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neurons' : spike_ids,'trial_averaged_histogram': False, 'spontaneous' : False}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='EvokedExcRasterL4.png').plot({'SpikeRasterPlot.group_trials':True})    
	RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L2/3', 'neurons' : spike_ids,'trial_averaged_histogram': False, 'spontaneous' : False}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='EvokedExcRasterL2/3.png').plot({'SpikeRasterPlot.group_trials':True})    
...
def perform_analysis_and_visualization(data_store):
    ...
    if True: # PLOTTING
	    ...
	    TrialToTrialVariabilityComparisonNew(data_store,ParameterSet({'sheet_name1' : 'V1_Exc_L4','sheet_name2' : 'V1_Exc_L2/3','data_dg' : 0.93 , 'data_ni' : 1.19}),fig_param={'dpi' : 200,'figsize': (15,7.5)},plot_file_name='TrialToTrialVariabilityComparisonNew.png').plot()
            ...
            SpontStatisticsOverview(data_store,ParameterSet({}), fig_param={'dpi' : 200,'figsize': (18,12)},plot_file_name='SpontStatisticsOverview.png').plot()
            if l23_flag:
                MRfigReal(param_filter_query(data_store,sheet_name=['V1_Exc_L2/3','V1_Exc_L4','V1_Inh_L2/3','V1_Inh_L4'],st_contrast=[100],st_name='FullfieldDriftingSinusoidalGrating'),ParameterSet({'SimpleSheetName' : 'V1_Exc_L4','ComplexSheetName' : 'V1_Exc_L2/3'}),plot_file_name='MRReal.png',fig_param={'dpi' : 100,'figsize': (19,12)}).plot()
            else:
                MRfigReal(param_filter_query(data_store,sheet_name=['V1_Exc_L2/3','V1_Exc_L4','V1_Inh_L2/3','V1_Inh_L4'],st_contrast=[100],st_name='FullfieldDriftingSinusoidalGrating'),ParameterSet({'SimpleSheetName' : 'V1_Exc_L4','ComplexSheetName' : 'V1_Exc_L2/3'}),plot_file_name='MRReal.png',fig_param={'dpi' : 100,'figsize': (19,12)}).plot()
...
def perform_analysis_and_visualization_or_small(data_store):
    ...
    if True:
            ...
            dsv = param_filter_query(data_store,st_name=['InternalStimulus'])    
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'X_ON', 'spontaneous' : False, 'neuron' : sorted(param_filter_query(data_store,sheet_name="X_ON").get_segments()[0].get_stored_esyn_ids())[0], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (14,12)},plot_file_name="LGN0On.png").plot()        
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'X_OFF','spontaneous' : False, 'neuron' : sorted(param_filter_query(data_store,sheet_name="X_OFF").get_segments()[0].get_stored_esyn_ids())[0], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (14,12)},plot_file_name="LGN0Off.png").plot()
            ...
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'X_ON', 'spontaneous' : False, 'neuron' : sorted(param_filter_query(data_store,sheet_name="X_ON").get_segments()[0].get_stored_esyn_ids())[0], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (14,12)},plot_file_name="LGN0OnGr.png").plot()        
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'X_OFF','spontaneous' : False, 'neuron' : sorted(param_filter_query(data_store,sheet_name="X_OFF").get_segments()[0].get_stored_esyn_ids())[0], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (14,12)},plot_file_name="LGN0OffGr.png").plot()
	    ...
	    if l23:
            ...
            MRfigReal(param_filter_query(data_store,sheet_name=['V1_Exc_L2/3','V1_Exc_L4'],st_contrast=[100],st_name='FullfieldDriftingSinusoidalGrating'),ParameterSet({'SimpleSheetName' : 'V1_Exc_L4','ComplexSheetName' : 'V1_Exc_L2/3'}),plot_file_name='MR.png',fig_param={'dpi' : 100,'figsize': (19,12)}).plot()
