...
def perform_analysis_and_visualization_conn(data_store):
    ...
    dsv = param_filter_query(
        data_store, identifier='PerNeuronValue', value_name='LGNAfferentOrientation')
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_exc_or_many[0], 'reversed': True, 'sheet_name': 'V1_Exc_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='ExcConnections1.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_exc_or_many[1], 'reversed': True, 'sheet_name': 'V1_Exc_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='ExcConnections2.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_exc_or_many[2], 'reversed': True, 'sheet_name': 'V1_Exc_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='ExcConnections3.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_exc_or_many[3], 'reversed': True, 'sheet_name': 'V1_Exc_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='ExcConnections4.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_exc_or_many[4], 'reversed': True, 'sheet_name': 'V1_Exc_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='ExcConnections5.png').plot()

    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_inh_or_many[0], 'reversed': True, 'sheet_name': 'V1_Inh_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='InhConnections1.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_inh_or_many[1], 'reversed': True, 'sheet_name': 'V1_Inh_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='InhConnections2.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_inh_or_many[2], 'reversed': True, 'sheet_name': 'V1_Inh_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='InhConnections3.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_inh_or_many[3], 'reversed': True, 'sheet_name': 'V1_Inh_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='InhConnections4.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l4_inh_or_many[4], 'reversed': True, 'sheet_name': 'V1_Inh_L4'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='InhConnections5.png').plot()

    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_exc_or_many[0], 'reversed': True, 'sheet_name': 'V1_Exc_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23ExcConnections1.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_exc_or_many[1], 'reversed': True, 'sheet_name': 'V1_Exc_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23ExcConnections2.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_exc_or_many[2], 'reversed': True, 'sheet_name': 'V1_Exc_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23ExcConnections3.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_exc_or_many[3], 'reversed': True, 'sheet_name': 'V1_Exc_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23ExcConnections4.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_exc_or_many[4], 'reversed': True, 'sheet_name': 'V1_Exc_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23ExcConnections5.png').plot()

    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_inh_or_many[0], 'reversed': True, 'sheet_name': 'V1_Inh_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23InhConnections1.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_inh_or_many[1], 'reversed': True, 'sheet_name': 'V1_Inh_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23InhConnections2.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_inh_or_many[2], 'reversed': True, 'sheet_name': 'V1_Inh_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23InhConnections3.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_inh_or_many[3], 'reversed': True, 'sheet_name': 'V1_Inh_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23InhConnections4.png').plot()
    mozaik.visualization.plotting.ConnectivityPlot(data_store, ParameterSet({'neuron': l23_inh_or_many[4], 'reversed': True, 'sheet_name': 'V1_Inh_L2/3'}), pnv_dsv=dsv, fig_param={
                                                   'dpi': 100, 'figsize': (34, 12)}, plot_file_name='L23InhConnections5.png').plot()
...
def perform_analysis_and_visualization_or(data_store):
    ...
    if True:
        ...
        MRfigReal(param_filter_query(data_store, sheet_name=['V1_Exc_L2/3', 'V1_Exc_L4'], st_contrast=[100], st_name='FullfieldDriftingSinusoidalGrating'), ParameterSet(
...
def perform_analysis_and_visualization_octc(data_store):
    ...
    l4_exc_or_many = numpy.array(spike_ids)[numpy.nonzero(numpy.array([circular_dist(
        l4_exc_or.get_value_by_id(i), 0, numpy.pi) for i in spike_ids]) < 0.3)[0]]
    l23_exc_or_many = numpy.array(spike_ids23)[numpy.nonzero(numpy.array([circular_dist(
        l23_exc_or.get_value_by_id(i), 0, numpy.pi) for i in spike_ids23]) < 0.3)[0]]
    l4_inh_or_many = numpy.array(spike_ids_inh)[numpy.nonzero(numpy.array([circular_dist(
        l4_inh_or.get_value_by_id(i), 0, numpy.pi) for i in spike_ids_inh]) < 0.3)[0]]
    l23_inh_or_many = numpy.array(spike_ids_inh23)[numpy.nonzero(numpy.array([circular_dist(
        l23_inh_or.get_value_by_id(i), 0, numpy.pi) for i in spike_ids_inh23]) < 0.3)[0]]

    idx23 = data_store.get_sheet_indexes(
        sheet_name='V1_Exc_L2/3', neuron_ids=l23_exc_or_many)
    idx4 = data_store.get_sheet_indexes(
        sheet_name='V1_Exc_L4', neuron_ids=l4_exc_or_many)
    idx_inh23 = data_store.get_sheet_indexes(
        sheet_name='V1_Inh_L2/3', neuron_ids=l23_inh_or_many)
    idx_inh4 = data_store.get_sheet_indexes(
        sheet_name='V1_Inh_L4', neuron_ids=l4_inh_or_many)

    x = data_store.get_neuron_postions()['V1_Exc_L4'][0][idx4]
    y = data_store.get_neuron_postions()['V1_Exc_L4'][1][idx4]
    center4 = l4_exc_or_many[numpy.nonzero(numpy.sqrt(
        numpy.multiply(x, x)+numpy.multiply(y, y)) < 0.1)[0]]
    x = data_store.get_neuron_postions()['V1_Exc_L2/3'][0][idx23]
    y = data_store.get_neuron_postions()['V1_Exc_L2/3'][1][idx23]
    center23 = l23_exc_or_many[numpy.nonzero(numpy.sqrt(
        numpy.multiply(x, x)+numpy.multiply(y, y)) < 0.1)[0]]
    ...
    TrialAveragedFiringRate(param_filter_query(data_store, sheet_name=[
                            'V1_Exc_L4', 'V1_Inh_L4', 'V1_Exc_L2/3', 'V1_Inh_L2/3'], st_name='DriftingSinusoidalGratingCenterSurroundStimulus'), ParameterSet({})).analyse()

    dsv = param_filter_query(data_store, st_name='DriftingSinusoidalGratingCenterSurroundStimulus',
                             analysis_algorithm=['TrialAveragedFiringRate'], value_name="Firing rate")
    logger.info(center23)
    PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': list(center4), 'sheet_name': 'V1_Exc_L4', 'centered': False,
                                       'mean': True, 'polar': False, 'pool': False}), plot_file_name='OCTCExcL4M.png', fig_param={'dpi': 100, 'figsize': (32, 15)}).plot()
    PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': list(center23), 'sheet_name': 'V1_Exc_L2/3', 'centered': False,
                                       'mean': True, 'polar': False, 'pool': False}), plot_file_name='OCTCExcL23M.png', fig_param={'dpi': 100, 'figsize': (32, 15)}).plot()
    PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': list(center4), 'sheet_name': 'V1_Exc_L4', 'centered': False,
                                       'mean': False, 'polar': False, 'pool': False}), plot_file_name='OCTCExcL4.png', fig_param={'dpi': 100, 'figsize': (32, 15)}).plot()
    PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'surround_orientation', 'neurons': list(center23), 'sheet_name': 'V1_Exc_L2/3', 'centered': False,
                                       'mean': False, 'polar': False, 'pool': False}), plot_file_name='OCTCExcL23.png', fig_param={'dpi': 100, 'figsize': (32, 15)}).plot()
    ...
    if True:
        dsv = param_filter_query(data_store, st_name=[
                                 'DriftingSinusoidalGratingCenterSurroundStimulus'], st_surround_orientation=[0, numpy.pi/2])
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L2/3', 'neuron': list(analog_center23)[0], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='Overview_ExcL23_1.png').plot()
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L2/3', 'neuron': list(analog_center23)[1], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='Overview_ExcL23_2.png').plot()
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L2/3', 'neuron': list(analog_center23)[2], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='Overview_ExcL23_3.png').plot()

        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L2/3', 'neuron': list(analog_center23_inh)[0], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='Overview_InhL23_1.png').plot()
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L2/3', 'neuron': list(analog_center23_inh)[1], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='Overview_InhL23_2.png').plot()
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L2/3', 'neuron': list(analog_center23_inh)[2], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='Overview_InhL23_3.png').plot()
...
def perform_analysis_and_visualization_spont(data_store):
    ...
    Analog_MeanSTDAndFanoFactor(param_filter_query(
        data_store, st_direct_stimulation_name=None), ParameterSet({})).analyse()
    TrialAveragedVarianceAndVarianceRatioOfConductances(param_filter_query(
        data_store, st_direct_stimulation_name=None), ParameterSet({})).analyse()
    PSTH(param_filter_query(data_store, st_direct_stimulation_name=None),
         ParameterSet({'bin_length': 10.0})).analyse()
    Irregularity(param_filter_query(
        data_store, st_direct_stimulation_name=None), ParameterSet({})).analyse()
    CrossCorrelationOfExcitatoryAndInhibitoryConductances(param_filter_query(
        data_store, st_direct_stimulation_name=None), ParameterSet({})).analyse()
    NeuronToNeuronAnalogSignalCorrelations(param_filter_query(
        data_store, analysis_algorithm='PSTH'), ParameterSet({'convert_nan_to_zero': True})).analyse()

    dsv = param_filter_query(data_store, st_direct_stimulation_name=None,
                             st_name="InternalStimulus", sheet_name=sheets, identifier='PerNeuronValue')
    dsv.print_content()
    ...
    dsv = param_filter_query(data_store, st_name=[
                             'InternalStimulus'], st_direct_stimulation_name=None)
    OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L4', 'neuron': analog_ids[0], 'sheet_activity': {
    }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='SSExcAnalogL4.png').plot()
    OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L4', 'neuron': analog_ids_inh[0], 'sheet_activity': {
    }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='SSInhAnalogL4.png').plot()

    if l23_flag:
        dsv = param_filter_query(data_store, st_name=[
                                 'InternalStimulus'], st_direct_stimulation_name=None)
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Exc_L2/3', 'neuron': analog_ids23[0], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='SSExcAnalogL23.png').plot()
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'V1_Inh_L2/3', 'neuron': analog_ids_inh23[0], 'sheet_activity': {
        }, 'spontaneous': True}), fig_param={'dpi': 100, 'figsize': (28, 12)}, plot_file_name='SSInhAnalogL23.png').plot()
    ...
    if l23_flag:
        SpontActOverview(data_store, ParameterSet({'l4_exc_neuron': analog_ids[0], 'l4_inh_neuron': analog_ids_inh[0], 'l23_exc_neuron': analog_ids23[
                         0], 'l23_inh_neuron': analog_ids_inh23[0]}), plot_file_name='SpontActOverview.png', fig_param={'dpi': 200, 'figsize': (15, 12)}).plot()
        SpontStatisticsOverview(data_store, ParameterSet({}), fig_param={
                                'dpi': 200, 'figsize': (15, 10)}, plot_file_name='SpontStatisticsOverview.png').plot()
    else:
        SpontActOverview(data_store, ParameterSet({'l4_exc_neuron': analog_ids[0], 'l4_inh_neuron': analog_ids_inh[0], 'l23_exc_neuron': -1,
                                                   'l23_inh_neuron': -1}), plot_file_name='SpontActOverview.png', fig_param={'dpi': 200, 'figsize': (15, 12)}).plot()
    SpontStatisticsOverview(data_store, ParameterSet({}), fig_param={
                            'dpi': 200, 'figsize': (15, 10)}, plot_file_name='SpontStatisticsOverview.png').plot()


def perform_analysis_and_visualization_or_small(data_store):
    l23 = False  # 'V1_Exc_L2/3' in set(data_store.sheets())
    ...
    if True:
        ...
        dsv = param_filter_query(data_store, st_name=['InternalStimulus'])
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_ON', 'spontaneous': False, 'neuron': sorted(param_filter_query(data_store, sheet_name="X_ON").get_segments()[
                     0].get_stored_esyn_ids())[0], 'sheet_activity': {}}), fig_param={'dpi': 100, 'figsize': (14, 12)}, plot_file_name="LGN0On.png").plot()
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_OFF', 'spontaneous': False, 'neuron': sorted(param_filter_query(data_store, sheet_name="X_OFF").get_segments()[
                     0].get_stored_esyn_ids())[0], 'sheet_activity': {}}), fig_param={'dpi': 100, 'figsize': (14, 12)}, plot_file_name="LGN0Off.png").plot()
        ...
        dsv = param_filter_query(
            data_store, st_name='FullfieldDriftingSinusoidalGrating', st_contrast=100, st_orientation=0)
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_ON', 'spontaneous': False, 'neuron': sorted(param_filter_query(data_store, sheet_name="X_ON").get_segments()[
                     0].get_stored_esyn_ids())[0], 'sheet_activity': {}}), fig_param={'dpi': 100, 'figsize': (14, 12)}, plot_file_name="LGN0OnGr.png").plot()
        OverviewPlot(dsv, ParameterSet({'sheet_name': 'X_OFF', 'spontaneous': False, 'neuron': sorted(param_filter_query(data_store, sheet_name="X_OFF").get_segments()[
                     0].get_stored_esyn_ids())[0], 'sheet_activity': {}}), fig_param={'dpi': 100, 'figsize': (14, 12)}, plot_file_name="LGN0OffGr.png").plot()
        ...
        if True:
            ...
            pylab.figure()
            pylab.bar([1, 2, 3, 4, 5], [numpy.mean(pref_fr_100),
                                        numpy.mean(ort_fr_100), 0, 0, numpy.mean(spont)])
            pylab.xticks([1.4, 2.4, 3.4, 4.4, 5.4], ['PREF100',
                                                     'ORT100', 'PREF50', 'ORT50', 'SPONT'])
            pylab.xlim([0.8, 6.0])
            pylab.ylabel("Firing rate")
            ...
            if l23:
                ...
                pylab.figure()
                pylab.bar([1, 2, 3, 4, 5], [numpy.mean(
                    pref_fr_100), 0, 0, 0, numpy.mean(spont)])
                pylab.xticks([1.4, 2.4, 3.4, 4.4, 5.4], [
                             'PREF100', 'ORT100', 'PREF50', 'ORT50', 'SPONT'])
                pylab.xlim([0.8, 6.0])
                pylab.ylabel("Firing rate")
        ...
        MRfigReal(param_filter_query(data_store, sheet_name=['V1_Exc_L2/3', 'V1_Exc_L4'], st_contrast=[100], st_name='FullfieldDriftingSinusoidalGrating'), ParameterSet(
            {'SimpleSheetName': 'V1_Exc_L4', 'ComplexSheetName': 'V1_Exc_L2/3'}), plot_file_name='MR.png', fig_param={'dpi': 100, 'figsize': (19, 12)}).plot()
