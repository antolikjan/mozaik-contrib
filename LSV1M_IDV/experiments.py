...
def create_experiments_stc(model):
    ...
    return  [
                           ...
                           #Size Tuning  
                           MeasureSizeTuning(model,ParameterSet({'num_sizes': 12,'max_size': 3.0,'log_spacing' : True,'orientation' : 0,'spatial_frequency' : 0.8,'temporal_frequency' : 2,'grating_duration' : 2*143*7,'contrasts' : [30,100],'num_trials' : 10})),
            ]
